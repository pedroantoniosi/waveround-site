      ...
      <Container className={styles.adContent}>
        <div className={styles.adCaption}>
          ...
          <p>
            ...
            absoluto e design sofisticado. Projetado para longas horas de uso
            sem perder a leveza e a precisão sonora. Eleva sua experiência
            auditiva a um novo nível de performance e estilo.
          </p>
        </div>
      </Container>
    </section>
